            ...
            <div class="container">
                <form method="POST" class="authen__form">
                    ...
                    <div class="mb-5">
                        ...
                        <input type="email" class="form-control <?=empty($error['email']) ? "" : 'is-invalid'?>"
                            id="email" aria-describedby="emailHelp" name="email" value="<?=$email?>" />
                    ...
                    <div class="mb-4 form-check">
                        <input type="checkbox" class="form-check-input" id="exampleCheck1" name="remember"
                            <?=$remember ? 'checked' : ""?> />
                        <label class="form-check-label authen__remember" for="exampleCheck1">Remember me</label>
                    </div>
                    <div class="my-4">
                    ...
                    <p class="authen__text">
                        ...
                        <a href="../signup/" class="authen__link">Đăng ký</a>
                    </p>
                </form>
            </div>
        </div>
